      ...
      <div class="starter-template">
        ...
        <form id="form_registro" role="form" method="post" action="<?php base_url('eventos/registro/save_register')?>">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name ="cedula_usuario" id="cedula_usuario"
                   placeholder="Introduce tu cedula" required="" >
          </div>
          ...
          <div class="form-group">
            ...
            <input type="date" class="datepicker-switch form-control" name="fech_facimiento" id="fech_facimiento"
          ...
          <div class="form-group">
            ...
            <input type="text" class="datepicker-switch form-control" name="tel_usuario" id="tel_usuario"
          ...
          <div class="form-group">
            ...
            <input type="text" class="datepicker-switch form-control" name="direccion_usuario" id="direccion_usuario"
