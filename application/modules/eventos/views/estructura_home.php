<body>
    ...
    <div class="container">
      <div class="starter-template">
        ...
        <p class="lead"><strong>Descripción:</strong><br><?php echo $evento[0]->detalle_evento; ?></p>
        <p class="lead"><strong>Dirección:</strong><br><?php echo $evento[0]->direccion_evento; ?></p>
        <p class="lead"><strong>Fecha inicio:</strong><br><?php echo $evento[0]->fecha_inicio; ?></p>
        <p class="lead"><strong>Hora inicio:</strong><br><?php echo $evento[0]->hora_inicio; ?></p>
        <p class="lead"><strong>Fecha finalizacón:</strong><br><?php echo $evento[0]->fecha_final; ?></p>
        <p class="lead"><strong>Hora finalizacón:</strong><br><?php echo $evento[0]->hora_final; ?></p>
        <div class="col-md-12" style="padding: 0;">
            <a href="<?php echo base_url('eventos/registro/index').'/'.$evento[0]->id; ?>" class="btn btn-warning ">Registrarme</a>
        </div>
      </div>
        <?php 
